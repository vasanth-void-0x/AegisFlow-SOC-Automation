...
const NAV_ITEMS = [
  ...
  { to: '/about', label: 'About BlueOrch', icon: 'info' },
]
const PAGE_TITLES: Record<string,string> = {'/':'Command Overview','/incidents':'Incident Queue','/approvals':'Approval Centre','/mcp-tools':'MCP Tool History','/audit':'Audit Log','/health':'System Health','/settings':'SIEM Settings','/about':'About BlueOrch'}
