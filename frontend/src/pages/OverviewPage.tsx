  ...
  return <div className="overview-page page-pad">
    ...
    <footer className="overview-footer">
      <nav className="footer-social" aria-label="Vasanth social links">
        ...
        <a href="https://vasanth-portfolio-ten.vercel.app/" target="_blank" rel="noreferrer" aria-label="Portfolio"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3 5h18v14H3zM8 5V3h8v2M3 10h18M10 10v2h4v-2"/></svg><span>Portfolio</span></a>
      </nav>
      <div className="footer-meta"><span>© 2026 <b>V</b></span><i>AEGISFLOW v1.0.0</i></div>
    </footer>
